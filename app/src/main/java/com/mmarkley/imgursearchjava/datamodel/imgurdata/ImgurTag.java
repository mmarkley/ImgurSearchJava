...
public class ImgurTag {
    ...
    @Expose
    private ImgurDescriptionAnnotations descriptionAnnotations;
    ...
    public ImgurDescriptionAnnotations getDescriptionAnnotations() {
        return descriptionAnnotations;
    }

    public void setDescriptionAnnotations(ImgurDescriptionAnnotations descriptionAnnotations) {
